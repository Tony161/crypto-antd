...
export default function AddAssetForm({onClose}) {
    ...
    if (!coin) {
        return (
            <Select
                ...
                optionRender={option => (
                    <Space>
                        <img style={{width: '10px'}} src={option.data.icon} alt={option.data.label} />{' '}
                        {option.data.label}
                    </Space>
                )}
            />
    ...
    return (
        ...
        >
            ...
            <Form.Item placeholder={'Enter coin amount'} onChange={handlePriceChange} label="Price" name="price">
